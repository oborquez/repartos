...
/**
 * This is the model class for table "evaluaciones_evaluadores".
 *
 * The followings are the available columns in table 'evaluaciones_evaluadores':
 * @property integer $id
 * @property integer $id_evento
 * @property integer $id_usuario
 */
class EvaluacionesEvaluadores extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return EvaluacionesEvaluadores the static model class
	 */
	...
	{
		return 'evaluaciones_evaluadores';
	}
