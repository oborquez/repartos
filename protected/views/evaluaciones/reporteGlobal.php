...
$ej = EvaluacionesEjecutadas::model()->findAll( "id_evento = ".$model->id );
$dataGraph = EvaluacionesRespuestas::model()->totalPorRubroEventoUsuario( $model->id, 0 );
			...
			<div class="col-md-3 text-center">-->
				<div class="stat-panel">
					<div class="stat-cell bg-success valign-middle">
						...
						<!-- Extra large text -->
						<span class="text-xlg"><span class="text-lg text-slim"></span><strong><? echo EvaluacionesRespuestas::model()->getCalificacionEvaluacionUsuario( $model->id, 0 ) ?></strong></span><br>
						<!-- Big text -->
	...
	<div class="panel-body">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="stat-panel text-center">
					<div class="stat-cell bg-warning valign-middle">
						...
						<!-- Extra large text -->
						<span class="text-xlg"><span class="text-lg text-slim"></span><strong><? echo EvaluacionesRespuestas::model()->getCalificacionEvaluacionUsuarioPregunta( $model->id, 0,$preg->id ) ?></strong></span><br>
						<!-- Big text -->
			...
			<div class="col-md-4">  
				...
				<? $respuestas = EvaluacionesRespuestas::model()->findAll( "id_evento = ".$model->id." AND id_pregunta = ".$preg->id ); ?>
			...
			<? $dataGraphP = EvaluacionesRespuestas::model()->totalPorRubroEventoUsuarioPregunta( $model->id, 0, $preg->id );
 ?>	
				<script type="text/javascript">
		...
		<div class="row">
			<h3>Comentarios</h3>
			<div class="div-respuestas">
				<? $comentarios = EvaluacionesComentarios::model()->findAll( "id_evento =".$model->id  ) ?>
